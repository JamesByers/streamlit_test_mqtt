...
with col1:
    broker = st.text_input("HiveMQ", "mqtt.335a3b21c7d1491180737a1f7d878b69.s2.eu.hivemq.cloud")
    port = st.text_input("MQTT Port", "8883")
    client_id = st.text_input("jims_iot", "steamlit_1")
...
with col3:
    subscribeTopic = st.text_input("temperature")
